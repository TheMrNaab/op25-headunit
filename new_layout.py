...
class OP25InitWorker(QThread):
    ...
    signal_initialized = Signal()  # ✅ Signal to notify UI when done
    ...
    def run(self):
        self.op25.start()
        self.signal_initialized.emit()  # ✅ Notify UI when ready
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.isMenuActive = False  # ✅ Add this line to track the talkgroup menu state
    ...
    def setupUi(self, MainWindow):
        ...
        self.lblChannelName_2 = QLabel(self.horizontalLayoutWidget)
...
"            }")
        ...
        self.horizontalLayout_13.addWidget(self.btnMenu)
        ...
        self.btnGroups.setStyleSheet(u"            QPushButton {\n"
"                background-color: #444;\n"
"                color: white;\n"
"                font-size: 16px;\n"
"                font-weight: bold;\n"
...
"            }")
        ...
        self.horizontalLayout_13.addWidget(self.btnGroups)
...
"            }")
        ...
        self.btnExit_2.setStyleSheet(u"            QPushButton {\n"
"                background-color: #444;\n"
"                color: white;\n"
"                font-size: 16px;\n"
"                font-weight: bold;\n"
...
"            }")
        ...
        self.horizontalLayout_13.addWidget(self.btnExit_2)


        self.functionButtonLayout.addLayout(self.horizontalLayout_13, 1, 0, 1, 1) # BOTTOM
        ...
        self.btnZnDown.setStyleSheet(u"            QPushButton {\n"
...
"            }")
        ...
        self.btnZnUp.setObjectName(u"btnZnUp")
        self.btnZnUp.setFont(font4)
        self.btnZnUp.setStyleSheet(u"            QPushButton {\n"
"                background-color: white;\n"
"                color: black;\n"
"                font-size: 16px;\n"
"                font-weight: bold;\n"
...
"            }")
        ...
        self.btnChUp.setObjectName(u"btnChUp")
        self.btnChUp.setFont(font4)
        self.btnChUp.setStyleSheet(u"            QPushButton {\n"
"                background-color: white;\n"
"                color: black;\n"
"                font-size: 16px;\n"
"                font-weight: bold;\n"
...
"            }")
        ...
        self.btnChDown.setStyleSheet(u"            QPushButton {\n"
"                background-color: white;\n"
"                color: black;\n"
"                font-size: 16px;\n"
"                font-weight: bold;\n"
...
"            }")
        ...
        self.functionButtonLayout.addLayout(self.horizontalLayout_12, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"MUTE", None))
        ...
        self.btnGroups.setText(QCoreApplication.translate("MainWindow", u"\uf009 GROUPS", None))
        ...
        self.pushButton_2.clicked.connect(self.toggle_mute)  # Mute Toggle
